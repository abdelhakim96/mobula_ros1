...
GaussianProcess::GaussianProcess()
{
    ...
    cf = NULL;
#if DEBUG_MODE
    std::cout << "Default Constructor of GaussianProcess is called!\n";
#endif
}
...
GaussianProcess::GaussianProcess(size_t input_dim, std::string covf_def)
{
    ...
    std_dev_y = 1;
#if DEBUG_MODE
    std::cout << "Parameter Constructor of GaussianProcess is called!\n";
#endif
}
...
#if DEBUG_MODE
    std::cout << "Copy Constructor of GaussianProcess is called!\n";
#endif
}
...
GaussianProcess::~GaussianProcess()
{
    ...
    if (cf != NULL)
        delete cf;
#if DEBUG_MODE
    std::cout << "Destructor of GaussianProcess is called!\n";
#endif
}
