...
void RProp::maximize(SparseGaussianProcess* sgp, size_t n, bool verbose)
{
    GaussianProcess *gp = new GaussianProcess((GaussianProcess)(*sgp));
    maximize(gp, n, verbose);
    sgp->covf().set_loghyper(gp->covf().get_loghyper());
}
