...
file_name_gp_nogp = os.path.join(folder_name, "real_nogp_t4.txt")
file_name_gp_lambda01 = os.path.join(folder_name, "real_gp1_t4.txt")
file_name_gp_lambda01_combined = os.path.join(folder_name, "real_gp1_t4.txt")
file_name_gp_lambda8 = os.path.join(folder_name, "real_gp8_t3.txt")
file_name_gp_lambda8_combined = os.path.join(folder_name, "real_gp8_t3.txt")
file_name_gp_mac_sine = os.path.join(folder_name, "real_dfgp_t4.txt")
file_name_gp_mac_test = os.path.join(folder_name, "real_dfgp_t4.txt")
file_name_gp_lambda9_sine = os.path.join(folder_name, "real_gp5_t4.txt")
file_name_gp_lambda9_test = os.path.join(folder_name, "real_gp5_t4.txt")
file_name_nogp_test = os.path.join(folder_name, "real_nogp_t4.txt.txt")
...
plt.plot(2.9 + 0.5*np.cos(theta), -1.5 + 0.5*np.sin(theta), linestyle='--', linewidth=2, label='Reference', color='black')
...
gt_y_1_scaled = [y / 1 for y in gt_y_1]
...
plot_dist1(plt, gt_y_mac, mu_y_mac, 'Ours', t_start, duration, color=colors[3])
