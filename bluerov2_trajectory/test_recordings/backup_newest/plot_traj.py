...
file_name_gp_nogp = os.path.join(folder_name, "no_gp_sine.txt")
file_name_gp_lambda01 = os.path.join(folder_name, "lamda01_sine.txt")
file_name_gp_lambda01_combined = os.path.join(folder_name, "lambda01_test.txt")
file_name_gp_lambda09 = os.path.join(folder_name, "lambda08_sine.txt")
file_name_gp_lambda09_combined = os.path.join(folder_name, "lambda08_test.txt")
