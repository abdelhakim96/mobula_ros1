...
file_name_gp_lambda01 = os.path.join(folder_name, "lambda1_test.txt")
file_name_gp_lambda01_combined = os.path.join(folder_name, "lambda1_test.txt")
file_name_gp_lambda8 = os.path.join(folder_name, "lambda1_test.txt")
...
#plt.plot(range(t_start, t_start + duration), distances_gp_mac_sine_closest[t_start:t_start + duration], color='cyan', label=f'Mac (Mean: {mean_distance_gp_mac_sine_closest:.3g})')
#plt.plot(range(t_start, t_start + duration), distances_gp_lambda9_sine_closest[t_start:t_start + duration], color='brown', label=f'Lambda 9 (Mean: {mean_distance_gp_lambda9_sine_closest:.3g})')
