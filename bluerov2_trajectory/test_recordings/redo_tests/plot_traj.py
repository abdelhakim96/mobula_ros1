...
file_name_gp_lambda8 = os.path.join(folder_name, "lambda888.txt")
file_name_gp_lambda8_combined = os.path.join(folder_name, "lambda888.txt")
file_name_gp_mac_sine = os.path.join(folder_name, "macnew.txt")
file_name_gp_mac_test = os.path.join(folder_name, "macnew.txt")
file_name_gp_lambda9_sine = os.path.join(folder_name, "97.txt")
file_name_gp_lambda9_test = os.path.join(folder_name, "97.txt")
...
plot_trajectories(plt, actual_positions_x_gp_lambda01, actual_positions_y_gp_lambda01, 'Lambda = 1.0', t_start+250, duration, 'green')
plot_trajectories(plt, actual_positions_x_gp_lambda9_sine, actual_positions_y_gp_lambda9_sine, 'Lambda = 0.5', t_start+250, duration, 'orange')
plot_trajectories(plt, actual_positions_x_gp_lambda8, actual_positions_y_gp_lambda8, 'Lambda = 0.8', t_start+250, duration, 'purple')
plot_trajectories(plt, actual_positions_x_gp_mac_sine, actual_positions_y_gp_mac_sine, 'Ours', t_start+250, duration, 'cyan')
plt.legend()
...
plot_dist(plt, mu_y_1, 'lambda = 1', t_start, duration+400, 'blue')
plot_dist(plt, mu_y_8, 'lambda = 0.8', t_start, duration+400, 'green')
plot_dist(plt, mu_y_9, 'lambda = 0.6', t_start, duration+400, 'red')
plot_dist(plt, mu_y_mac, ' ours ', t_start+200, duration, 'cyan')
plot_dist1(plt, gt_y_9, 'ground truth',  t_start, duration, color= 'black')
...
plt.figure(figsize=(12, 6))
plot_dist1(plt, gt_y_1, mu_y_1, 'Error (Lambda = 1)', t_start, duration+400, 'blue')
plot_dist1(plt, gt_y_9, mu_y_9, 'Error (Lambda = 0.5)', t_start, duration+400, 'red')
plot_dist1(plt, gt_y_mac, mu_y_mac, 'Error (Ours)', t_start, duration, 'cyan')
plot_dist1(plt, gt_y_8, mu_y_8, 'Error (Lambda = 0.8)', t_start, duration+400, 'orange')
