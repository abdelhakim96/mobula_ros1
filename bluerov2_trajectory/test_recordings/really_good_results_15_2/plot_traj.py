...
file_name_gp_nogp = os.path.join(folder_name, "lambda55.txt")
file_name_gp_lambda01 = os.path.join(folder_name, "1new.txt")
file_name_gp_lambda01_combined = os.path.join(folder_name, "1new.txt")
...
file_name_gp_mac_test = os.path.join(folder_name, "mac.txt")
file_name_gp_lambda9_sine = os.path.join(folder_name, "lambda66.txt")
file_name_gp_lambda9_test = os.path.join(folder_name, "lambda66.txt")
...
plot_trajectories(plt, actual_positions_x_gp_lambda9_sine, actual_positions_y_gp_lambda9_sine, 'Lambda = 0.5', t_start, duration, 'orange')
...
plot_dist(plt, mu_y_8, 'lambda = 0.8', t_start, duration, 'green')
plot_dist(plt, mu_y_9, 'lambda = 0.5', t_start, duration, 'red')
